...
cut -f1 ANGSD_basin-wide/sites.txt | sort | uniq > ANGSD_basin-wide/chrs.txt
...
angsd -P ${SLURM_CPUS_ON_NODE} -bam ANGSD_basin-wide/${POP}.list -ref A_boucheti.Trinity.merged95.filtered.fasta -anc A_boucheti.Trinity.merged95.filtered.fasta -gl 1 -baq 1 -C 50 -minInd ${FRAC} -sites ANGSD_basin-wide/sites.txt -rf ANGSD_basin-wide/chrs.txt -minMapQ 30 -minQ 20 -setMinDepth 2 -setMaxDepth 160 -doCounts 1 -uniqueOnly 1 -remove_bads 1 -only_proper_pairs 1 -doMaf 1 -doMajorMinor 4 -doSaf 2 -indF ANGSD_basin-wide/${POP}.indF -doThetas 1 -pest ANGSD_basin-wide/${POP}.sfs -out ANGSD_basin-wide/${POP}
done

/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS ANGSD_basin-wide/KM.saf.idx ANGSD_basin-wide/TC.saf.idx -tole 1e-6 -maxIter 5000 -fold 1 -P ${SLURM_CPUS_ON_NODE} > ANGSD_basin-wide/KM-TC.folded.sfs
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst index ANGSD_basin-wide/KM.saf.idx ANGSD_basin-wide/TC.saf.idx -sfs ANGSD_basin-wide/KM-TC.folded.sfs -fold 1 -fstout ANGSD_basin-wide/KM-TC -whichFST 1 -maxIter 5000
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS ANGSD_basin-wide/KM.saf.idx ANGSD_basin-wide/ABE.saf.idx -tole 1e-6 -maxIter 5000 -fold 1 -P ${SLURM_CPUS_ON_NODE} > ANGSD_basin-wide/KM-ABE.folded.sfs
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst index ANGSD_basin-wide/KM.saf.idx ANGSD_basin-wide/ABE.saf.idx -sfs ANGSD_basin-wide/KM-ABE.folded.sfs -fold 1 -fstout ANGSD_basin-wide/KM-ABE -whichFST 1 -maxIter 5000
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS ANGSD_basin-wide/KM.saf.idx ANGSD_basin-wide/TM.saf.idx -tole 1e-6 -maxIter 5000 -fold 1 -P ${SLURM_CPUS_ON_NODE} > ANGSD_basin-wide/KM-TM.folded.sfs
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst index ANGSD_basin-wide/KM.saf.idx ANGSD_basin-wide/TM.saf.idx -sfs ANGSD_basin-wide/KM-TM.folded.sfs -fold 1 -fstout ANGSD_basin-wide/KM-TM -whichFST 1 -maxIter 5000
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS ANGSD_basin-wide/TC.saf.idx ANGSD_basin-wide/ABE.saf.idx -tole 1e-6 -maxIter 5000 -fold 1 -P ${SLURM_CPUS_ON_NODE} > ANGSD_basin-wide/TC-ABE.folded.sfs
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst index ANGSD_basin-wide/TC.saf.idx ANGSD_basin-wide/ABE.saf.idx -sfs ANGSD_basin-wide/TC-ABE.folded.sfs -fold 1 -fstout ANGSD_basin-wide/TC-ABE -whichFST 1 -maxIter 5000
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS ANGSD_basin-wide/TC.saf.idx ANGSD_basin-wide/TM.saf.idx -tole 1e-6 -maxIter 5000 -fold 1 -P ${SLURM_CPUS_ON_NODE} > ANGSD_basin-wide/TC-TM.folded.sfs
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst index ANGSD_basin-wide/TC.saf.idx ANGSD_basin-wide/TM.saf.idx -sfs ANGSD_basin-wide/TC-TM.folded.sfs -fold 1 -fstout ANGSD_basin-wide/TC-TM -whichFST 1 -maxIter 5000
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS ANGSD_basin-wide/ABE.saf.idx ANGSD_basin-wide/TM.saf.idx -tole 1e-6 -maxIter 5000 -fold 1 -P ${SLURM_CPUS_ON_NODE} > ANGSD_basin-wide/ABE-TM.folded.sfs
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst index ANGSD_basin-wide/ABE.saf.idx ANGSD_basin-wide/TM.saf.idx -sfs ANGSD_basin-wide/ABE-TM.folded.sfs -fold 1 -fstout ANGSD_basin-wide/ABE-TM -whichFST 1 -maxIter 5000

/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst stats ANGSD_basin-wide/KM-TC.fst.idx -whichFST 1 -maxIter 5000 > ANGSD_basin-wide/KM-TC.fst.txt
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst stats ANGSD_basin-wide/KM-ABE.fst.idx -whichFST 1 -maxIter 5000 > ANGSD_basin-wide/KM-ABE.fst.txt
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst stats ANGSD_basin-wide/KM-TM.fst.idx -whichFST 1 -maxIter 5000 > ANGSD_basin-wide/KM-TM.fst.txt
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS fst stats ANGSD_basin-wide/TC-ABE.fst.idx -whichFST 1 -maxIter 5000 > ANGSD_basin-wide/TC-ABE.fst.txt
...
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS ANGSD_basin-wide/${POP}.saf.idx -tole 1e-6 -maxIter 5000 -P ${SLURM_CPUS_ON_NODE} -fold 1 > ANGSD_basin-wide/${POP}.sfs
angsd -P ${SLURM_CPUS_ON_NODE} -bam ${POP}.list -ref A_boucheti.Trinity.merged95.filtered.fasta -anc A_boucheti.Trinity.merged95.filtered.fasta -gl 1 -baq 1 -C 50 -minInd ${FRAC} -minMapQ 30 -minQ 20 -setMinDepth 2 -setMaxDepth 160 -doCounts 1 -uniqueOnly 1 -remove_bads 1 -only_proper_pairs 1 -doMaf 1 -doMajorMinor 4 -doSaf 2 -indF ANGSD_basin-wide/${POP}.indF -doThetas 1 -pest ANGSD_basin-wide/${POP}.sfs -out ANGSD_basin-wide/${POP}
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/realSFS saf2theta ANGSD_basin-wide/${POP}.saf.idx -outname ANGSD_basin-wide/${POP} -sfs ANGSD_basin-wide/${POP}.sfs -fold 1
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/thetaStat do_stat ANGSD_basin-wide/${POP}.thetas.idx
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/thetaStat print ANGSD_basin-wide/${POP}.thetas.idx > ANGSD_basin-wide/${POP}.thetas
/gpfs/data/rbeinart/Software/ngsTools/angsd/misc/thetaStat do_stat ANGSD_basin-wide/${POP}.thetas.idx -win 500 -step 100 -outnames ANGSD_basin-wide/${POP}.thetas
